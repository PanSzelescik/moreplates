...
public class Strings {
	...
	public static String INGOT = "ingot";
	...
	public static String INFO_EMPOWERER = INFO_1 + EMPOWERER_NAME + INFO_2 + INFO_8;
	...
	public static String INFO_RECONSTRUCTOR = INFO_1 + RECONSTRUCTOR_NAME + INFO_2 + INFO_8;
	...
	public static String INSANIUM = "Insanium";
	
	//Mystical Agriculture
	public static String INFERIUM = "Inferium";
	public static String INTERMEDIUM = "Intermedium";
	public static String PRUDENTIUM = "Prudentium";
	public static String SOULIUM = "Soulium";
	...
	//Project Red
	public static String ELECTROTINE = "Electrotine" + ALLOY;
	public static String RED_ALLOY = "Red" + ALLOY;
