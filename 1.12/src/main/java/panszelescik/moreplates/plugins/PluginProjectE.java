...
public class PluginProjectE {
	...
	public static void preInit() {
		dark_matter_gear = new ItemDarkMatterGear("dark_matter_gear");
		dark_matter_plate = new ItemDarkMatterPlate("dark_matter_plate");
		red_matter_gear = new ItemRedMatterGear("red_matter_gear");
		red_matter_plate = new ItemRedMatterPlate("red_matter_plate");
